...
export const AVAILABLE_MODELS = [
  ...
  // HuggingFace Free Models (accessible via HuggingFace Inference API; specify huggingFaceId)
  { id: 'hf-bloom-560m', name: 'BLOOM 560M', provider: 'HuggingFace', icon: '🌸', huggingFaceId: 'bigscience/bloom-560m' },
  { id: 'hf-falcon-7b', name: 'Falcon 7B', provider: 'HuggingFace', icon: '🦅', huggingFaceId: 'tiiuae/falcon-7b' },
  { id: 'hf-starcoder', name: 'StarCoder', provider: 'HuggingFace', icon: '⭐', huggingFaceId: 'bigcode/starcoder' },
  { id: 'hf-flan-t5', name: 'Flan-T5 XL', provider: 'HuggingFace', icon: '🧪', huggingFaceId: 'google/flan-t5-xl' },
  { id: 'hf-opt-6.7b', name: 'OPT 6.7B', provider: 'HuggingFace', icon: '🔮', huggingFaceId: 'facebook/opt-6.7b' },
  { id: 'hf-gpt2-xl', name: 'GPT-2 XL', provider: 'HuggingFace', icon: '🤖', huggingFaceId: 'gpt2' },
  { id: 'hf-pythia-6.9b', name: 'Pythia 6.9B', provider: 'HuggingFace', icon: '🐍', huggingFaceId: 'EleutherAI/pythia-6.9b' },
  { id: 'hf-mpt-7b', name: 'MPT 7B', provider: 'HuggingFace', icon: '🏗️', huggingFaceId: 'mosaicml/mpt-7b' },
  { id: 'hf-redpajama', name: 'RedPajama 7B', provider: 'HuggingFace', icon: '🔴', huggingFaceId: 'togethercomputer/RedPajama-INCITE-Base-7B-v0.1' },
  { id: 'hf-dolly-v2', name: 'Dolly v2 7B', provider: 'HuggingFace', icon: '🐑', huggingFaceId: 'databricks/dolly-v2-7b' },
  { id: 'hf-stablelm', name: 'StableLM 7B', provider: 'HuggingFace', icon: '⚖️', huggingFaceId: 'stabilityai/stablelm-7b' },
  { id: 'hf-cerebras', name: 'Cerebras GPT', provider: 'HuggingFace', icon: '🧩', huggingFaceId: 'cerebras/Cerebras-GPT-13B' },
  { id: 'hf-santacoder', name: 'SantaCoder', provider: 'HuggingFace', icon: '🎅', huggingFaceId: 'bigcode/santacoder' },
  { id: 'hf-codegen', name: 'CodeGen 6B', provider: 'HuggingFace', icon: '💻', huggingFaceId: 'Salesforce/codegen-6b' },
  { id: 'hf-opt-1.3b', name: 'OPT 1.3B', provider: 'HuggingFace', icon: '🔹', huggingFaceId: 'facebook/opt-1.3b' },
  { id: 'hf-gpt-neo', name: 'GPT-Neo 2.7B', provider: 'HuggingFace', icon: '🌐', huggingFaceId: 'EleutherAI/gpt-neo-2.7b' },
  { id: 'hf-bloomz', name: 'BLOOMZ 7B', provider: 'HuggingFace', icon: '🌻', huggingFaceId: 'bigscience/bloomz-7b1' },
];
